...
module.exports = {
    forbidden: [
        {
            name: 'domain-cant-import-from-domain-infrastructure',
            severity: 'error',
            comment: 'NOekenoekuanto',
            from: {
                path: 'core/domain',
            },
            to: {
                path: 'infrastructure',
                pathNot: 'infrastructure/shared',
            },
        },
        {
            name: 'no-circular',
...
// generated: dependency-cruiser@16.2.1 on 2024-02-20T15:44:21.976Z
