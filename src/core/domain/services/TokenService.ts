...
export class TokenService {
    ...
    private async generateToken(user: Partial<User>, expiration: string, key: string): Promise<string> {
...
export const TokenServiceProvider = {
  ...
  useFactory: (configService: ConfigService, jwtService: JwtService) => new TokenService(jwtService, configService),
